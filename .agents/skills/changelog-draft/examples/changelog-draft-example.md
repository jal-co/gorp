...
- [ ] ([#9655](https://github.com/warpdotdev/warp/pull/9655)) "feat(uri): add warposs://pane/{uuid} deep link for pane focus" — confidence: medium, reason: new feature but no changelog marker
- [ ] ([#10206](https://github.com/warpdotdev/warp/pull/10206)) "Keep empty child agent pills visible after exiting agent view" — confidence: low, reason: UI refinement vs bug fix ambiguous
- [ ] ([#9988](https://github.com/warpdotdev/warp/pull/9988)) "open local->cloud mode conversation in the same pane" — confidence: medium, reason: user-visible UX change, unclear if stable-gated

## Skipped PRs (sample of 154 unmarked)
| PR | Author | Reason |
|----|--------|--------|
| [#10220](https://github.com/warpdotdev/warp/pull/10220) | captainsafia | Internal tooling (skill config) |
| [#10204](https://github.com/warpdotdev/warp/pull/10204) | captainsafia | Docs only (README badges) |
| [#10203](https://github.com/warpdotdev/warp/pull/10203) | cephalonaut | Dogfood-gated (bundled skills) |
| [#10197](https://github.com/warpdotdev/warp/pull/10197) | zachbai | Internal refactor (data model migration) |
| [#10199](https://github.com/warpdotdev/warp/pull/10199) | zachlloyd | Dependency bump (mermaid_to_svg) |
| [#10167](https://github.com/warpdotdev/warp/pull/10167) | zachbai | Internal refactor (data model) |
| [#10183](https://github.com/warpdotdev/warp/pull/10183) | harryalbert | Internal tooling (harness selector) |
| [#10188](https://github.com/warpdotdev/warp/pull/10188) | nihalxkumar | Internal (parallel precheck) |
